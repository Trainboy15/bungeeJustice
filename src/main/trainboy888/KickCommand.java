...
public class KickCommand extends Command implements TabExecutor {
    ...
    public KickCommand(PunishmentManager manager, MessageConfig messageConfig, OfflineNameResolver nameResolver) {
        super("kick", "bungeejustice.kick");
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            sender.sendMessage(new TextComponent(messageConfig.getFormatted("messages.usage-kick", Map.of("command", getName()))));
            return;
        }
        ...
        // Create kick record for history
        manager.punishPlayer(uuid, PunishmentType.KICK, reason, actor, -1);
